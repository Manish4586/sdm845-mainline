...
static int sofef00_panel_on(struct sofef00_panel *ctx)
{
	...
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0x5A, 0x5A);
	// dsi_dcs_write_seq(dsi, 0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB0, 0x07);
	// dsi_dcs_write_seq(dsi, 0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB7, 0x01);
	// dsi_dcs_write_seq(dsi, 0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB0, 0x08);
	// dsi_dcs_write_seq(dsi, 0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB7, 0x12);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0xA5, 0xA5);

	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xFC, 0x5A, 0x5A);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB0, 0x01);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xE3, 0x88);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB0, 0x07);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xED, 0x67);
	
	// UNUSED IN VIDEO MODE
	// dsi_dcs_write_seq(dsi, 0xf0, 0x5a, 0x5a);
	...
	//Don't send display on command in video mode (??)
	...
	// /* DLY, OFF*/
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0x5A, 0x5A);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x04, 0xB7, 0x00, 0x01, 0x5B);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0xA5, 0xA5);
	// dsi_dcs_write_seq(dsi, 0x15, 0x01, 0x00, 0x00, 0x0A, 0x00, 0x02, 0x53, 0xE0);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0x51, 0x03, 0xFF);
	// /* DLY, ON*/
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0x5A, 0x5A);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x04, 0xB7, 0x00, 0x01, 0x53);
	// dsi_dcs_write_seq(dsi, 0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0xA5, 0xA5);
